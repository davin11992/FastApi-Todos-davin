...
# ✅ Loki 로그 전송을 위한 필수 구성
listener = QueueListener(queue, loki_handler.handler)
listener.start()

# 테스트 로그 한 줄 출력 (시작 시 로그 전송 확인용)
custom_logger.info("✅ FastAPI 서버가 시작되었으며 Loki에 로그 전송을 시도합니다.")
